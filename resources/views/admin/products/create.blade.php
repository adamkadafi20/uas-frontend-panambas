...
<section class="content-header">
    <div class="container-fluid my-3">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="font-weight-bold" style="color: #333;">Tambah Produk Baru</h1>
                <p class="text-muted mt-1" style="font-size: 15px;">Masukkan foto, nama, atau detail spesifikasi produk.</p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            @enderror
                            <small class="text-muted float-right mt-1" id="title-count">0/255</small>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="sku" id="sku" class="form-control px-3 py-2" value="{{ old('sku') }}" placeholder="Masukkan Kode Unik Produk (Opsional)" style="border-radius: 6px;">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group mb-3 shadow-sm" id="btn-open-category" style="cursor: pointer; border-radius: 6px; overflow: hidden;">
                                <input type="text" id="category_display" class="form-control px-3" placeholder="Pilih kategori yang sesuai..." readonly required style="background-color: #fff; cursor: pointer; pointer-events: none; border-right: none;">
            ...
            <div class="card mb-4 border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
                ...
                <div class="card-body p-4">
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" id="description" class="form-control p-3" rows="8" placeholder="Tuliskan deskripsi lengkap, keunggulan, atau cara penggunaan produk..." style="border-radius: 8px;" required>{{ old('description') }}</textarea>
                            <div class="d-flex justify-content-end mt-2">
                                <small class="text-muted font-weight-bold" id="char-count">0/3000</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="brand" id="brand-select" class="form-control" style="border-radius: 6px;" required>
                                <option value="Tidak Ada Merek">Tidak Ada Merek</option>
                                <option value="Bayer">Bayer</option>
                                <option value="Infarm">Infarm</option>
                    ...
                    <div id="more-specs" class="d-none mt-3 p-4" style="background-color: #fbfbfb; border-radius: 8px; border: 1px solid #f0f0f0;">
                        <div id="spec-tanaman" class="spec-group row">
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Tinggi / Ukuran Tanaman</label><select name="size" class="form-control"><option value="">Silakan pilih</option><option value="kecil">Bibit (10-30 cm)</option><option value="sedang">Remaja (30-60 cm)</option><option value="besar">Dewasa (> 60 cm)</option></select></div>
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Kebutuhan Cahaya</label><select name="light_requirement" class="form-control"><option value="">Silakan pilih</option><option value="full_sun">Panas Penuh (Full Sun)</option><option value="partial_shade">Teduh Parsial</option><option value="indoor">Indoor (Minim Cahaya)</option></select></div>
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Warna Utama</label><input type="text" name="color" class="form-control" placeholder="Contoh: Merah, Hijau"></div>
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Saran Perawatan</label><select name="care_level" class="form-control"><option value="">Silakan pilih</option><option value="easy">Mudah (Pemula)</option><option value="medium">Menengah</option><option value="hard">Expert</option></select></div>
                        </div>

                        <div id="spec-pupuk" class="spec-group row d-none">
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Bentuk Pupuk</label><select name="bentuk_pupuk" class="form-control"><option value="">Silakan pilih</option><option value="cair">Cair</option><option value="padat">Padat / Butiran</option><option value="serbuk">Serbuk</option></select></div>
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Volume / Berat Isi</label><input type="text" name="volume_isi" class="form-control" placeholder="Contoh: 1 Liter, 5 Kg"></div>
                        </div>

                        <div id="spec-peralatan" class="spec-group row d-none">
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Bahan / Material</label><input type="text" name="bahan_material" class="form-control" placeholder="Contoh: Plastik, Besi"></div>
                            <div class="col-md-6 mb-3"><label class="text-muted font-weight-bold">Dimensi (P x L x T)</label><input type="text" name="dimensi" class="form-control" placeholder="Contoh: 20cm x 20cm x 15cm"></div>
                        </div>
                    </div>
            ...
            <div class="card mb-4 border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-group mb-4 pb-4 border-bottom">
                        ...
                        <div id="wrapper-enable-variation">
                        ...
                        <div id="variation-form-container" class="d-none mt-2">
                            <div style="background-color: #fcfcfc; padding: 25px; border-radius: 8px; border: 1px solid #eaeaea; position: relative;">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <input type="text" id="var1-name" name="variation_name" class="form-control bg-white flex-fill px-3" value="Varian" placeholder="Contoh: Warna, Ukuran, Jenis" style="border-radius: 6px;">
                                        ...
                                        <div id="var1-options-list" class="row">
                                            <div class="col-md-6 mb-3 var-option-row">
                                                <div class="d-flex align-items-center">
                                                    <input type="text" class="form-control var1-option mr-2 px-3" placeholder="Contoh: Merah, Besar, dll" style="border-radius: 6px;">
                                                    <button type="button" class="btn btn-outline-danger btn-sm remove-var-btn" style="display:none; border-radius: 6px;"><i class="fas fa-trash"></i></button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="variation-table-section" class="d-none mt-4 pt-4 border-top">
                                ...
                                <div class="table-responsive border" style="border-radius: 8px;">
                                    <table class="table table-bordered text-center align-middle mb-0" style="font-size: 14px;" id="var-table">
                                        <thead style="background-color: #f4f6f9; color: #555;" id="var-table-head">
                                            <tr>
                                                <th class="col-var1 align-middle py-3" style="width: 250px;">Variasi</th>
                    ...
                    <div id="single-input-section">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="input-group shadow-sm" style="border-radius: 6px; overflow: hidden; max-width: 300px;">
                                    ...
                                    <input type="number" name="price" class="form-control" style="border-left: none;" value="{{ old('price') }}" placeholder="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="qty" class="form-control px-3" value="{{ old('qty') }}" placeholder="0" style="border-radius: 6px; max-width: 150px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="min_qty" class="form-control px-3" value="1" style="border-radius: 6px; max-width: 150px;" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-md-9">
                            <select name="max_purchase_type" id="max_purchase_type" class="form-control" style="border-radius: 6px; max-width: 250px;">
                                ...
                                <option value="per_order">Batas Per Pesanan</option>
                            </select>
                            
                            <div id="max_limit_container" class="d-none mt-3 p-3 shadow-sm" style="background-color: #f9fdf6; border-radius: 6px; border: 1px solid #e1ead9; max-width: 350px;">
                                ...
                                <input type="number" name="max_purchase_limit" class="form-control px-3" placeholder="Contoh: 5">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-5 border-0 shadow-sm" style="border-radius: 12px; margin-bottom: 80px !important;">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-9">
                            <div class="input-group shadow-sm" style="border-radius: 6px; overflow: hidden; max-width: 250px;">
                                <input type="number" name="weight" class="form-control px-3" value="{{ old('weight') }}" placeholder="Berat barang">
                                <div class="input-group-append">
                    ...
                    <div class="text-right border-top pt-4 mt-2">
                        ...
                        <button type="submit" class="btn px-5 shadow-sm text-white font-weight-bold" style="background-color: #3f7a08; border: none; border-radius: 6px; padding-top: 10px; padding-bottom: 10px;">Simpan & Tampilkan</button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
                    ...
                    <tr class="var-row" data-key="${key}">
                        <td class="align-middle">
                            <div class="d-flex align-items-center justify-content-start pl-3">
                                <div class="var-table-img-box border d-flex align-items-center justify-content-center mr-3" style="width: 45px; height: 45px; border-style: dashed !important; cursor: pointer; background: #fff; border-radius: 6px; flex-shrink: 0;" data-key="${key}">
                                    ${imgHtml}
                                </div>
        ...
        function updateTrashButtons() { 
            $('#var1-options-list .var-option-row').length > 1 ? $('#var1-options-list .remove-var-btn').show() : $('#var1-options-list .remove-var-btn').hide(); 
        }
        ...
        $(document).on('click', '.remove-var-btn', function() { 
            $(this).closest('.var-option-row').remove(); 
            updateTrashButtons(); 
        ...
        function loadRecentCategories() {
            ...
            let firstCat = recent[0]; $('#category_display').val(firstCat); $('#category_id').val(firstCat); updateSpesifikasiForm(firstCat); $(`#cat0`).prop('checked', true);
        }
        ...
        if ($('.is-invalid').length > 0) {
            ...
            $('.is-invalid').first().fadeOut(150).fadeIn(150).fadeOut(150).fadeIn(150);
        }
    });
