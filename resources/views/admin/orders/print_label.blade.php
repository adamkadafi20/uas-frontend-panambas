...
<head>
    ...
    <title>Cetak Resi - {{ $order->invoice_number }}</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="no-print" style="text-align: center; margin-bottom: 20px;">
        <button onclick="window.print()" style="padding: 10px 20px; font-size: 16px; cursor: pointer; background: #1d7b67; color: #fff; border: none; border-radius: 5px;">
            Cetak Sekarang
        </button>
    </div>
