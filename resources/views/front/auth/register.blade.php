...
<body class="bg-[#247a6b] min-h-screen flex flex-col">
    <header class="bg-white py-4 px-8 flex justify-between items-center shadow-sm">
        <div class="flex items-center space-x-4">
            ...
            <span class="text-2xl font-medium text-gray-800">Daftar</span>
        </div>
    ...
    <main class="flex-grow flex items-center justify-center px-4 md:px-20 py-10 max-w-7xl mx-auto w-full relative">
        ...
        <div class="w-full md:w-[400px] bg-white rounded-lg shadow-xl p-8">
            <h2 class="text-2xl font-medium text-gray-800 mb-8">Daftar</h2>
            ...
            <form action="{{ route('register.post') }}" method="POST">
                ...
                <div class="mb-8 relative">
                    <input type="password" name="password_confirmation" placeholder="Konfirmasi Password" class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-[#247a6b]" required>
                </div>
                <button type="submit" class="w-full bg-[#247a6b] hover:bg-[#1b5e52] text-white font-medium py-3 rounded uppercase transition duration-200 shadow-md">Daftar</button>
            </form>

            <p class="text-center text-gray-600 text-sm mt-8">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-[#247a6b] font-bold hover:underline">Log in</a>
            </p>
        </div>
    </main>
</body>
